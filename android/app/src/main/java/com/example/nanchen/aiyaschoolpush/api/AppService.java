...
public class AppService {
     ...
     * @param callback  回调
     */
    public void getNoticeAsync(int classId, int infoType, int count, JsonCallback<LslResponse<List<InfoModel>>> callback){
        String url = Consts.API_SERVICE_HOST+"/info/info_main.php?classId="+classId+
                "&infoType="+infoType+"&count="+count;
        OkGo.get(url).execute(callback);
    }
     ...
     * @param callback  回调接口
     */
    public void updatePraiseAysnc(int mainId, String username, JsonCallback<LslResponse<Object>> callback){
